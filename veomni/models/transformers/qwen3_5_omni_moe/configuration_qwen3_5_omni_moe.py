...
class Qwen3_5OmniMoeAudioEncoderConfig(PreTrainedConfig):
    r"""
    ...
    model_type = "qwen3_5_omni_moe_audio_encoder"
...
class Qwen3_5OmniMoeThinkerConfig(PreTrainedConfig):
    r"""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if isinstance(audio_config, dict):
            audio_config = Qwen3_5OmniMoeAudioEncoderConfig(**audio_config)
...
class Qwen3_5OmniMoeTalkerCodePredictorConfig(PreTrainedConfig):
    r"""
    ...
    model_type = "qwen3_5_omni_moe_talker_code_predictor"
    keys_to_ignore_at_inference = ["past_key_values"]
...
class Qwen3_5OmniMoeTalkerTextConfig(PreTrainedConfig):
    r"""
    ...
    model_type = "qwen3_5_omni_moe_talker_text"
    keys_to_ignore_at_inference = ["past_key_values"]
...
class Qwen3_5OmniMoeTalkerConfig(PreTrainedConfig):
    r"""
    ...
    sub_configs = {
        "code_predictor_config": Qwen3_5OmniMoeTalkerCodePredictorConfig,
        "text_config": Qwen3_5OmniMoeTalkerTextConfig,
    }
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if code_predictor_config is None:
            ...
            self.code_predictor_config = Qwen3_5OmniMoeTalkerCodePredictorConfig()
            logger.info("code_predictor_config is None. Initializing code_predictor_config model with default values")
        elif isinstance(code_predictor_config, Qwen3_5OmniMoeTalkerCodePredictorConfig):
            self.code_predictor_config = code_predictor_config
        else:
            self.code_predictor_config = Qwen3_5OmniMoeTalkerCodePredictorConfig(**code_predictor_config)

        if text_config is None:
            text_config = {}
            self.text_config = Qwen3_5OmniMoeTalkerTextConfig()
            logger.info("talker text_config is None. Initializing talker text model with default values")
        elif isinstance(text_config, Qwen3_5OmniMoeTalkerTextConfig):
            self.text_config = text_config
        else:
            self.text_config = Qwen3_5OmniMoeTalkerTextConfig(**text_config)
        self.num_code_groups = num_code_groups
...
class Qwen3_5OmniMoeCode2WavConfig(PreTrainedConfig):
    r"""
...
class Qwen3_5OmniMoeConfig(PreTrainedConfig):
    """
    ...
    model_type = "qwen3_5_omni_moe"
    sub_configs = {
        "thinker_config": Qwen3_5OmniMoeThinkerConfig,
        "talker_config": Qwen3_5OmniMoeTalkerConfig,
        "code2wav_config": Qwen3_5OmniMoeCode2WavConfig,
    }
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.thinker_config = Qwen3_5OmniMoeThinkerConfig(**thinker_config)
        self.talker_config = Qwen3_5OmniMoeTalkerConfig(**talker_config)
        self.code2wav_config = Qwen3_5OmniMoeCode2WavConfig(**code2wav_config)
...
__all__ = ["Qwen3_5OmniMoeConfig", "Qwen3_5OmniMoeThinkerConfig", "Qwen3_5OmniMoeTalkerConfig"]
